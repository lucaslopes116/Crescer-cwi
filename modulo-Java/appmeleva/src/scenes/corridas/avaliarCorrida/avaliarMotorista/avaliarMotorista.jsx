...
class avaliarMotorista extends Component {
    constructor() {
        super()
...
avaliar = () =>{    
    this.corridaService.avaliarMotorista(this.state.idCorrida,this.state.avaliacaoMotorista).then((response) =>{
        ...
        <Fragment>
            ...
            <div className="containerFormRegistro--motorista">
                <form onSubmit={this.onSubmit} className="formularioLoginRegistro--passageiro" autocomplete="off" >
                    <div className="textoEntrar">Avaliar motorista</div>
